...
p32_carbon_density_ac(t,j,"plant",ac,"vegc")  = pm_carbon_density_ac(t,j,ac,"vegc") * p32_management_factor(j);

*** YIELDS
p32_yield_forestry_ac(j,ac_sub) =
   (
     (2)
     *
     pm_carbon_density_ac(t,j,ac_sub,"vegc") * p32_management_factor(j)
     *
     0.85
     /
...
pc32_yield_forestry_future(j) = sum(ac_sub$(ord(ac_sub) = p32_rotation_cellular_estb(t,j)), p32_yield_forestry_ac(j,ac_sub));
